...
import 'package:taski/data/repo_impl/photo_repo_impl.dart' as _i10;
...
import 'package:taski/domain/repositories/photo_repository.dart' as _i9;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i8.FirebaseStorage>(appModule.firebaseStorage());
    gh.singleton<_i9.PhotoRepository>(
        _i10.PhotoRepoImpl(gh<_i8.FirebaseStorage>()));
    ...
    gh.factory<_i22.EditProfilePageCubit>(() => _i22.EditProfilePageCubit(
          gh<_i13.UserRepository>(),
